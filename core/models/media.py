"""Media and YouTube-related models."""
...
class VideoMetadata(models.Model):
    ...
    team1 = models.ForeignKey(
        "core.Team", on_delete=models.SET_NULL, null=True, related_name="team1"
    )
    team2 = models.ForeignKey(
        "core.Team", on_delete=models.SET_NULL, null=True, related_name="team2"
    )
    ...
    def reset_teams(self) -> None:
        """Reset all both team."""
        teams = Team.identify_team(self.name)
        self.team1 = teams[0]
        self.team2 = teams[1]
...
class YTVideo(models.Model):
    ...
    def upload_description(self) -> None:
        """Met a jour le titre/description/statut de la video YouTube liee."""
    ...
    def upload_miniature(self) -> None:
        """Met a jour uniquement la miniature (thumbnail) de la video YouTube liee."""
